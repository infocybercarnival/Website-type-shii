...
# Supply the SQLAlchemy-compatible Supabase connection string as DATABASE_URL.
# Do not put a Supabase API JWT/service-role key here.
SQLALCHEMY_DATABASE_URI = os.environ.get("DATABASE_URL", "")
if not SQLALCHEMY_DATABASE_URI and IS_PRODUCTION:
    raise RuntimeError(
        "DATABASE_URL is not set. Refusing to start in production without "
...
# The Vercel frontend and Flask backend are separate sites in production.
# None + Secure is required for the browser to send the session cookie cross-site.
